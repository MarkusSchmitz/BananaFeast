...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, 
        ...
        def step(self, state, action, reward, next_state, done):
            ...
            self.timestep = (self.timestep + 1) % UPDATE_INTERVAL
        ...
        def learn(self, experiences):
            ...
            qtargets = rewards + (gamma * Q_targets_next * (1 - dones))
            ...
            self.update_targetNet(self, localNet, TargetNet)
            self.lvl += 1
        ...
        def update_targetNet(self, local_model, target_model):
            ...
            for local_weight, target_weight in zip(target_model.parameters(), local_model.parameters()):
                ...
                updated_weight = tau * local_weight.data + (1.0-tau) * target_weight.data
        ...
        def get_stats(self):
            ...
            return (self.exp, self.lvl, self.scoremax)